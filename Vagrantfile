...
Vagrant.configure("2") do |config|
  ...
  # config.vm.synced_folder "/Users/fredrik/Documents/GitHub/lundgrenlindqvist/theme/src/acf-json", "/vagrant/acf-json", :owner => "www-data", :group => "www-data", :mount_options => ["dmode=755,fmode=644"]
